        ...
        <div className="flex flex-col h-full p-8">
          ...
          <div className="mt-8 mb-6">
            ...
            <p className="text-gray-600 mt-1">
              or <Link to="/register" className="text-indigo-600 hover:text-indigo-700">Create an account</Link>
            </p>
          </div>
          ...
          <div className="text-center text-xs text-gray-500 mt-auto pt-6">
            <p>
              ...
              <Link to="/terms" className="text-indigo-600 hover:text-indigo-700 ml-1">Terms & Conditions</Link>,
            </p>
            <p className="mt-1">
              <Link to="/privacy" className="text-indigo-600 hover:text-indigo-700">Privacy Policy</Link> & 
              <Link to="/refund" className="text-indigo-600 hover:text-indigo-700"> Refund Policy</Link>
            </p>
          </div>
