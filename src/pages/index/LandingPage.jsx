    ...
    <div className="min-h-[70vh] relative">
      ...
      >
        <div className="w-4/5 mx-auto flex relative z-10">
          ...
          <div
            className="w-[55%] relative flex justify-center items-center"
      ...
      <div className="w-full bg-white py-4 border-b border-t border-gray-200">
        <div className="w-4/5 mx-auto flex items-center">
          ...
          <div className="w-2/3 overflow-hidden h-12">
      ...
      <div className="w-4/5 mx-auto py-12 px-4">
        <h2 className="text-3xl font-semibold mt-12 mb-6 text-gray-800">
          Featured Courses
        </h2>
      ...
      <div className="w-full bg-white py-24">
        <div className="w-4/5 mx-auto flex flex-col md:flex-row items-start justify-between gap-12">
          ...
          <div className="md:w-1/2 flex justify-center md:justify-end sticky top-20">
            {" "}
            <img
